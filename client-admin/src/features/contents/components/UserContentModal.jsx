...
export const UserContentModal = ({ content, onClose }) => {
    ...
    return (
        <div
            className='xl:hidden fixed inset-0 z-50 flex items-center justify-center p-3 sm:p-4 bg-black/40 backdrop-blur-sm animate-fadeIn'
            onClick={handleBackdrop}
        >
            <div className='bg-white rounded-3xl w-full max-w-lg shadow-2xl flex flex-col max-h-[calc(100vh-24px)] sm:max-h-[90vh] overflow-hidden animate-fadeInScale relative'>
                <button
                    onClick={onClose}
